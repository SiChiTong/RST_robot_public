...
struct  STRUCT_485_USARTx_Fram strEsp8266_Fram_Record = { 0 };
...
{  
	...
	OSTimeDly ( waittime, OS_OPT_TIME_DLY, & err );               //延时
...
bool ESP8266_JoinAP ( char * pSSID, char * pPassWord )
{
	...
	a = ESP8266_Cmd ( cCmd, "OK", NULL, 5000 );
	return a;
}
...
void ESP8266_ExitUnvarnishSend ( void )
{
	...
	OSTimeDlyHMSM(0,0,0,1000,OS_OPT_TIME_DLY,&err);     //延时1000ms
	
	macESP8266_Usart ( "+++" );
	
	OSTimeDlyHMSM(0,0,0,500,OS_OPT_TIME_DLY,&err);     //延时1000ms
