...
#define HUOER_INT_GPIO_PORT         GPIOD
#define HUOER_INT_GPIO_CLK          (RCC_APB2Periph_GPIOD|RCC_APB2Periph_AFIO)//打开APB2使能时钟以及AFIO
#define HUOER_INT_GPIO_PIN          GPIO_Pin_2


//定义中断寄存器，中断源
#define HUOER_INT_EXTI_PORTSOURCE   GPIO_PortSourceGPIOD//中断源寄存器A
